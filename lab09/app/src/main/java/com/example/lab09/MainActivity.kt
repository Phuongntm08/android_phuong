...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var drawerLayout: DrawerLayout = findViewById(R.id.myDrawerLayout)
        var navView: NavigationView = findViewById(R.id.myDrawerView)
        ...
        navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                R.id.sentMailId -> {
                    Snackbar.make(findViewById(R.id.sentMailId),"Your Email has been sent successfully",
